...
namespace OTA_Portal_Service.Migrations
{
    ...
    [Migration("20240821095306_mirated")]
    partial class mirated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OTA_Portal_Service.Models.Entities.Trainee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OTA_Portal_Service.Models.Entities.TrainingCenterCapacity", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("trainingCenterCapacities");
                });
            ...
            modelBuilder.Entity("OTA_Portal_Service.Models.Entities.Trainee", b =>
                {
                    b.HasOne("OTA_Portal_Service.Models.Entities.Batch", "Batch")
                        .WithMany()
                        .HasForeignKey("BatchId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OTA_Portal_Service.Models.Entities.PersonalProfile", "Person")
                        .WithMany()
